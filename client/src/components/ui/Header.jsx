    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 z-10">
          <p className="text-sm font-semibold block cursor-pointer p-2 rounded-full hover:bg-gray-200">Airbnb your home</p>
          <RiGlobalLine className="text-lg" />
          <Link
            to={user ? '/account' : '/login'}
            className="w-50 flex h-full items-center gap-2 rounded-full border-gray-300 px-2 py-1 md:border hover:shadow-md"
          >
            <svg
      ...
      {showSearchBar && <SearchBar hasShadow = {hasShadow}/>}
    </header>
  );
};
